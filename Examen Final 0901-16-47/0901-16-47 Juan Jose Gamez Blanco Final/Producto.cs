...
namespace _0901_16_47_Juan_Jose_Gamez_Blanco_Final
{
    ...
    {
        string usuario;
        public Producto(string user)
        {
            InitializeComponent();
            usuario = user;
            LblUsuario.Text = usuario;
            string[] alias = { "No", "Nombre", "linea", "Marca", "Exisencia", "Estado" }; // Arreglo de nombres para campos
            ...
            navegador1.asignarComboConTabla("lineas", "nombre_linea", 1); // 0 o 1 en modo, 0 pone el id y 1 coloca el nombre y consulta el id
            navegador1.asignarComboConTabla("marcas", "nombre_marca", 1); // 0 o 1 en modo, 0 pone el id y 1 coloca el nombre y consulta el id
            navegador1.asignarComboConTabla("existencias", "codigo_producto ", 1); // 0 o 1 en modo, 0 pone el id y 1 coloca el nombre y consulta el id
